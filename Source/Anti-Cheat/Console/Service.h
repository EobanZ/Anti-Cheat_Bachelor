...
public:
	//Constructor
	CService(void);
	CService(const char* _lpFilePath, const char* _lpServiceName, const char* _lpDisplayName, DWORD _dwStartType);
	//Destructor
	~CService(void);

	//init function
	DWORD InitSvc(const char* _lpFilePath, const char* _lpServiceName, const char* _lpDisplayName, DWORD _dwStartType);
...
private:
	...
	const char* lpFilePath; //driver file path
	const char* lpServiceName; //service name
	const char* lpDisplayName; //service's dos name
